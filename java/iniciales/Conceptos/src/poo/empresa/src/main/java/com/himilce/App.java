...
public class App {
    ...
    public static String ruta = "C:\\Modulo\\PROGRAMACION\\java\\iniciales\\Conceptos\\src\\poo\\empresa\\public";
    ...
    public static void main (String[] args){
        ...
        // App.load();
        App.lectura();
        /* menu añadir lista Lempleados
         * inicio prog ejecutar lempleados
         * 1- empleado
         * 2 contable
         * 3 director
         * 4 mostrar informes
         * num totoal. saldotot. hextra de (d,c,e)
         * guarda inform.json
         * 5- guardar
         */
    }
